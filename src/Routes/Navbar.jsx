...
const location = [
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/mumbai.png", name: "Mumbai" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/ncr-selected.png", name: "NCR" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/bang.png", name: "Bangaluru" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/hyd.png", name: "Hyderabad" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/ahd.png", name: "Ahemdabad" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/chd.png", name: "Chandigarh" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/chen.png", name: "Chennai" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/pune.png", name: "Pune" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/kolk.png", name: "Kolkata" },
    { link: "https://in.bmscdn.com/m6/images/common-modules/regions/koch.png", name: "Kochi" }
]
const Navbar = () => {
    ...
    const handleCloseLogin = (number) => {
        if (+number == 7275584516 ) {
          ...
          //  handleCloseLogin(number)
            ...
            alert("Plase Enter Valide number")
        }
        setAction(false);
        setState(false)
    }
        ...
        <div >
            ...
            >
                <DialogContent className={styles.Dialog}>
                    <DialogContentText className={styles.location_content}>
                        <SearchIcon />
                        <input style={{ border: 'none', width: '550px', height: '40px', outline: 'none' }}
                            type="text"
            ...
            <div className={styles.secondNav}>
                <div>
                    ...
                    <Link className={styles.link} to="">Stream</Link>
                    <Link className={styles.link} to="">Events</Link>
                    <Link className={styles.link} to="">Plays</Link>
                    <Link className={styles.link} to="">Sports</Link>
                    <Link className={styles.link} to="">Activities</Link>
                    <Link className={styles.link} to="">Fanhood</Link>
                    <Link className={styles.link} to="">Buzz</Link>
                </div>
                <div>
                    <Link className={styles.link} to="">Listyourshow</Link>
                    <Link className={styles.link} to="">Corporates</Link>
                    <Link className={styles.link} to="">Offers</Link>
                    <Link className={styles.link} to="">Gift Cards</Link>
                </div>
            </div>
        </div>
    )
